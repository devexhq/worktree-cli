...
from getworktree.core.workflows.models import WorkflowContextInclude
...
def build_failure_payload(
    *,
    ...
    sandbox_path: Path,
    include: list[WorkflowContextInclude],
    ...
    Args:
        ...
        include: Workflow context include tokens to attach.
