...
class CatalogMutationTests:
    """Tests for Catalog mutation operations using assert_model contract validation."""
    ...
    def test_catalog_templates_and_seed(self, fs: FileSystem) -> None:
        catalog = Catalog(fs.base_path)
