...
class HistoryFormattersTests:
    """Unit tests for history Rich renderers and formatters."""
    ...
    def test_format_run_status(self) -> None:
...
class HistoryServiceDirectTests:
    """Unit tests for HistoryListService and HistoryShowService data collection and execution."""
    ...
    def test_collect_history_show(self, fs: FileSystem) -> None:
...
class HistoryCliTests:
    """CLI integration tests for 'wt history' list command."""
    ...
    def test_cli_history_empty(self, fs: FileSystem, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_cli_history_uninitialized_exits_1(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        assert "CONFIG_NOT_FOUND" in result.output or "Config Error" in result.output


class HistoryShowCliTests:
    """CLI integration tests for 'wt history show' command."""
    ...
    def test_cli_history_show_raw_checkpoint_json_fallback(
    ...
    def test_cli_history_show_not_found(self, fs: FileSystem, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_cli_history_show_uninitialized(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
