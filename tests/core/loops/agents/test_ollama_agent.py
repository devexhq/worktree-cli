...
from getworktree.core.loops.validate import validate_loop_document
...
class SchemaOllamaTests:
    ...
    def test_loop_schema_accepts_ollama(self) -> None:
        raw = {
            "version": 1,
            "name": "fix-tests",
            "description": "x",
        ...
        result = validate_loop_document(raw, source_path=Path("in-memory.yml"))
        assert result.ok, result.errors

    def test_loop_schema_rejects_openai(self) -> None:
        raw = {
            "version": 1,
            "name": "fix-tests",
            "description": "x",
