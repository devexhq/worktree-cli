"""Tests for `getworktree.core.loops.seeder`."""
...
class SeedStarterLoopsTests:
    """Tests for `seed_starter_loops`."""

    def test_seed_starter_loops_creates_missing_files(self, tmp_path: Path) -> None:
    ...
    def test_seed_starter_loops_skips_existing_files_by_default(
        self, tmp_path: Path
    ) -> None:
        loops_dir = tmp_path / "loops"
    ...
    def test_seed_starter_loops_handles_partial_existing_state(
        self, tmp_path: Path
    ) -> None:
        loops_dir = tmp_path / "loops"
        loops_dir.mkdir(parents=True, exist_ok=True)
    ...
    def test_seed_starter_loops_reports_directory_collisions(
        self, tmp_path: Path
    ) -> None:
        loops_dir = tmp_path / "loops"
        loops_dir.mkdir(parents=True, exist_ok=True)
