...
class BuildWorkflowInventoryTests:
    ...
    def test_empty_directory(self, fs: FileSystem) -> None:
        workflows_dir = fs.base_path / "workflows"
        workflows_dir.mkdir()

        result = build_workflow_inventory(cwd=fs.base_path, workflows_dir=workflows_dir)
    ...
    def test_all_valid_seeded_starters(self, fs: FileSystem) -> None:
        workflows_dir = fs.base_path / "workflows"
    ...
    def test_mixed_valid_and_invalid(self, fs: FileSystem) -> None:
        workflows_dir = fs.base_path / "workflows"
        assert seed_starter_workflows(workflows_dir).ok
    ...
    def test_all_invalid(self, fs: FileSystem) -> None:
        workflows_dir = fs.base_path / "workflows"
        workflows_dir.mkdir()
    ...
    def test_discovery_failure_passthrough(self, fs: FileSystem) -> None:
        missing = fs.base_path / "missing-workflows"

        result = build_workflow_inventory(cwd=fs.base_path, workflows_dir=missing)
    ...
    def test_valid_ordering_by_name_then_path(self, fs: FileSystem) -> None:
        workflows_dir = fs.base_path / "workflows"
        workflows_dir.mkdir()
    ...
    def test_invalid_ordering_by_filename(self, fs: FileSystem) -> None:
        workflows_dir = fs.base_path / "workflows"
        workflows_dir.mkdir()
    ...
    def test_duplicate_name_warnings(self, fs: FileSystem) -> None:
        workflows_dir = fs.base_path / "workflows"
        workflows_dir.mkdir()
    ...
    def test_invalid_entries_do_not_join_duplicate_warnings(self, fs: FileSystem) -> None:
        workflows_dir = fs.base_path / "workflows"
        workflows_dir.mkdir()
    ...
    def test_unreadable_file_is_invalid_only(self, fs: FileSystem) -> None:
        workflows_dir = fs.base_path / "workflows"
        workflows_dir.mkdir()
    ...
    def test_explicit_workflows_dir_does_not_need_config(self, fs: FileSystem) -> None:
        workflows_dir = fs.base_path / "only"
        workflows_dir.mkdir()
